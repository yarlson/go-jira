...
[![GoDoc](https://godoc.org/github.com/yarlson/go-jira?status.svg)](https://godoc.org/github.com/yarlson/go-jira)
[![Build Status](https://travis-ci.org/yarlson/go-jira.svg?branch=master)](https://travis-ci.org/yarlson/go-jira)
[![Go Report Card](https://goreportcard.com/badge/github.com/yarlson/go-jira)](https://goreportcard.com/report/github.com/yarlson/go-jira)
...
```bash
go get github.com/yarlson/go-jira
```
...
import (
	jira "gopkg.in/yarlson/go-jira.v1"
)
...
```
...
```bash
cd $GOPATH/src/github.com/yarlson/go-jira
go test -v ./...
```

## API

Please have a look at the [GoDoc documentation](https://godoc.org/github.com/yarlson/go-jira) for a detailed API description.
...
A few more examples are available in the [GoDoc examples section](https://godoc.org/github.com/yarlson/go-jira#pkg-examples).
...
For more details have a look at the [issue #56](https://github.com/yarlson/go-jira/issues/56).
...
please look at [Pagination Example](https://github.com/yarlson/go-jira/blob/master/examples/pagination/main.go)
...
Creating issues or holding talks and help other people to use [go-jira](https://github.com/yarlson/go-jira) is contribution, too!
A few examples:

* Correct typos in the README / documentation
* Reporting bugs
* Implement a new feature or endpoint
* Sharing the love of [go-jira](https://github.com/yarlson/go-jira) and help people to get use to it
...
[https://github.com/yarlson/go-jira/releases/edit/v1.11.0](https://github.com/yarlson/go-jira/releases/edit/v1.11.0)
